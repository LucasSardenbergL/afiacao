...
-- ----------------------------------------------------------------------------
-- Valida os valores REAIS de status_titulo e o frescor dos dados antes de
-- qualquer outra query. O front filtra por strings que NÃO existem no banco
-- ('ATRASADO', 'A VENCER', 'VENCE HOJE'); o sync grava MAIÚSCULO
-- ('ABERTO','VENCIDO','PAGO','PARCIAL','CANCELADO'). Confirme aqui.
