...
5. **`deleted_at` nunca usado em prod** (0 linhas em 30.114) apesar de 4 call sites no front — investigar se o fluxo de soft-delete está morto ou se a edge apaga logo em seguida.
