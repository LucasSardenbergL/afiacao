...
| corante | `corante.codigo` verbatim (GABARITO: `CORANTES.CSV` codigo=1..16 é o espaço dos slots e do app; ex. codigo `3` = WP04 AZUL; o id interno NÃO aparece no export) — slots `corante1..6` são FK→id, o conector traduz id→codigo | `3`, `12` |
