...
- ⚠️ **Passo 3** (RPC do motor: remove `em_transito` [CTE+join+termo do `estoque_efetivo`] + barreira fail-closed) · **Passo 4** (bump no disparo) · **Passo 5** (Sentinela usa o marcador) — PENDENTES.
