...
- ⏳ **GATE founder:** (1) **Publish** + conferir F1 no device (selo/card/badge/painel `/whatsapp/sla`); (2) aplicar a migration F2 (digest) no SQL Editor. O cron passa a disparar o e-mail às 18h (seg-sex).
