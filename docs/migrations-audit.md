...
### `20260624040000_tactical_plan_rpc_hardening_codex.sql`
...
### `20260625120000_get_ultimos_precos_cliente.sql`
...
| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public.ss_allowlist_forca_autor` | — |
| `function` | `public.selfservice_conta_atual` | — |
| `table` | `public.selfservice_cliente_allowlist` | — |
| `index` | `public.idx_ss_allowlist_customer` | `selfservice_cliente_allowlist` |
| `trigger` | `public.trg_ss_allowlist_autor` | `selfservice_cliente_allowlist` |
...
### `20260814000125_reposicao_pos_frescor_marcador.sql`

| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public.reposicao_pos_candidatos` | — |
| `function` | `public.reposicao_pos_marcador` | — |

### `20260814022626_reposicao_po_inexistente_antes_de.sql`
...
### `20260821192817_omie_identidade_a2_client_to_user.sql`
...
### `20260824234500_sync_state_products_vendas_aposenta_writer_truncado.sql`

| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public._data_health_compute` | — |

### `20260825124938_cron_metadados_timeout_240s.sql`
...
### `20260907230000_farmer_ordem_e_referencia_ambigua.sql`

| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public.farmer_recomendacoes_substituir` | — |
| `function` | `public.farmer_melhores_individuais_por_cliente` | — |
...
### `20260908070850_deploy_sonda_alvos_onda2.sql`

> _Nenhum objeto extraído via regex._ Migration provavelmente é `ALTER TABLE` / `UPDATE` / `INSERT` / RLS-only. Validar manualmente.

### `20260908072658_order_items_desconto_valor.sql`
...
### `20260918200000_data_health_sync_reprocess_saude.sql`
...
### `20260920210000_sync_reprocess_retry_nao_liquida_erro.sql`

| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public._data_health_compute` | — |

### `20260920233000_sync_reprocess_degradado_so_das_vigiadas.sql`

| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public._data_health_compute` | — |

### `20260922225449_oportunidade_erro_terminal_nao_bloqueia_oferta.sql`
...
### `20260925225004_reposicao_em_transito_simulado_e_join_grupo_null_safe.sql`

| Tipo | Objeto | Parent |
| --- | --- | --- |
| `function` | `public.gerar_pedidos_sugeridos_ciclo` | — |

### `20260926001425_param_auto_em_transito_conta_disparado_simulado.sql`
