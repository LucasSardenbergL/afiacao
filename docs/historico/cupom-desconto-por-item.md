...
- **O painel de detalhe do pedido** (`SalesOrderDetailSheet`): coberto na continuação [painel-desconto-por-item.md](painel-desconto-por-item.md) (#2508) — a mesma régua na tela, e a leitura de `order_items` que falhou vira aviso, nunca "sem desconto" (o compartilhar por WhatsApp foi coberto na continuação acima).
