...
-- disparo 3 · etapa dry1 · página 1
-- Passo 1 refeito com o bundle v1.3 (sensor do valor): diagnóstico, NÃO é aprovação de escrita.
--
...
DECLARE
  ...
  c_arquivo constant text  := 'db/desconto-backfill-oben/003-dry1-p001.sql';
