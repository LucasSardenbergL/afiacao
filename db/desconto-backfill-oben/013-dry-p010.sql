...
-- disparo 13 · etapa dry · página 10
-- Passada dry automática — página 10 (conduzir.sh). Passo 2 (dry-run completo). Alvo congelado 2026-09-11T00:56:57Z: 10558 linhas / 4851 pedidos, sha256(ids ordenados)=4632ae892491208c0f663ced660742af83e5d5743cc4e84be1521ee07e79ce56.
--
...
DECLARE
  ...
  c_arquivo constant text  := 'db/desconto-backfill-oben/013-dry-p010.sql';
