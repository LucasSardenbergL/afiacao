...
-- disparo 49 · etapa dry · página 46
-- Passada dry automática — página 46 (conduzir.sh). Passo 2 (dry-run completo). Alvo congelado 2026-09-11T00:56:57Z: 10558 linhas / 4851 pedidos, sha256(ids ordenados)=4632ae892491208c0f663ced660742af83e5d5743cc4e84be1521ee07e79ce56.
--
...
DECLARE
  ...
  c_arquivo constant text  := 'db/desconto-backfill-oben/049-dry-p046.sql';
