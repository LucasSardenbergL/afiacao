-- PASSO 1 — dispara as 2 edge(s) baratas da leva. Exige ESCRITA: lê o vault e
...
WITH esperado(edge, versao_esperada, fonte_esperada) AS (VALUES
  ('disparar-pedidos-aprovados', 'v1.3-email-implantado-sayerlack', '1314123154efb90881ce7e92f562cfcae0f4b23a2f5a8a0c96bfc968778080d6'),
  ('dispatch-notifications', 'v1.1-resumo-param-so-no-app', 'b46aa29eabbd5164d1270768ebd65b31a09bdf1da9359c3f4f2c92b5ef6a8f89')
),
ids AS (
