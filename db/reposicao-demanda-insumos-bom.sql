...
WHERE v.empresa = 'OBEN'                       -- guard: nunca cruzar empresa
  ...
  -- [#10] allowlist POSITIVA de venda de SAÍDA (Codex 2026-07-12). Só operação que representa saída de
  -- venda de produto/mercadoria consome insumo — simétrica produção própria × terceiros × contribuinte ×
  -- não-contribuinte: produção própria (5101/6101 a contribuinte, 5107/6107 a não-contribuinte — TINGIMIX
  -- é fabricado internamente) + revenda de terceiros (5102/6102 a contribuinte [únicos com ficha hoje],
  -- 5108/6108 a não-contribuinte). EXCLUI 6202 (devolução de COMPRA: saída, mas NÃO venda — 'LIKE 5%/6%'
  -- a incluiria e fabricaria consumo falso; 5 linhas reais em prod, 0 de pai com ficha). Devolução de venda
  -- é entrada (1xxx/2xxx), nunca chega aqui. Sentinela p/ CFOP de venda novo: spec §5 (query de vigilância).
