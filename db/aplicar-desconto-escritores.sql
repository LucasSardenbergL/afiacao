-- ============================================================
-- APLICAÇÃO via `bun run db:aplicar` — os TRÊS escritores de order_items passam a transportar desconto_valor
--
-- Mesmo EFEITO da migration `20260908215704_desconto_valor_atravessa_os_escritores.sql`,
