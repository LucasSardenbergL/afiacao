...
-- Total de custom migrations: 542
--
-- Como usar:
...
WITH expected (version, slug, filename) AS (VALUES
  ...
  ('20260906190615', 'reposicao_claim_disparo_cenario_b', '20260906190615_reposicao_claim_disparo_cenario_b.sql'),
...
expected_objects (migration, kind, schema_name, object_name, parent_name) AS (VALUES
  ...
  ('reposicao_claim_disparo_cenario_b', 'function', 'public', 'reposicao_claim_disparo', ''),
  ('reposicao_claim_disparo_cenario_b', 'function', 'public', 'reposicao__veta_cancelamento_com_disparo_pendente', ''),
  ('reposicao_claim_disparo_cenario_b', 'trigger', 'public', 'trg_veta_cancelamento_com_disparo_pendente', 'pedido_compra_sugerido'),
...
WITH corpo_esperado (schema_name, object_name, ordem, migration, body_md5) AS (VALUES
  ...
  ('public', 'criar_pedidos_com_itens', 4, '20260908215704_desconto_valor_atravessa_os_escritores.sql', 'e2dff1d5b5e55b626a72820fbf2846fc'),
  ...
  ('public', 'cockpit_itens_snapshot', 1, '20260830123820_snapshot_atomico_universo_itens.sql', '88bd481f1d36ab3ba72e7d9df1f1d206'),
  ('public', 'cockpit_itens_snapshot', 2, '20260908222500_snapshot_transporta_desconto_valor.sql', 'a574d6225b93610547e57526585694a6'),
