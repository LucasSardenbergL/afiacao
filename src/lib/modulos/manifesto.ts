...
export const MODULOS: ModuloApp[] = [
  ...
  },
  {
    ...
    testes: [
      ...
      "src/hooks/__tests__/cross-sell-preco-referencia.test.tsx",
  ...
  },
  {
    ...
    testes: [
      ...
      "src/hooks/__tests__/bundle-escopo-carteira.test.tsx",
      ...
      "src/hooks/__tests__/bundle-head-registra-vazio-sem-linha.test.tsx",
      ...
      "src/hooks/__tests__/bundle-identidade-account.test.tsx",
      "src/hooks/__tests__/bundle-universo-pedidos.test.tsx",
