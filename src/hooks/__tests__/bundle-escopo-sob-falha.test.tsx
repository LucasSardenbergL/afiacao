 ...
 * `[]`, indistinguível de "este farmer não tem carteira", e o código concluía "deve ser
 * super_admin", recarregando a base INTEIRA.
 *
 ...
 *
 * Irmão de `cross-sell-escopo-sob-falha.test.tsx` (mesmo defeito no useCrossSellEngine).
 * Separados porque os hooks pertencem a MÓDULOS diferentes — `useBundleEngine` é de
 ...
 * o dono do cliente. Ver `bundle-escopo-carteira.test.tsx`. Este arquivo
...
describe('useBundleEngine — página que falha não vira "sem carteira, deve ser super_admin"', () => {
