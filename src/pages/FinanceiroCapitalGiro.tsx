...
const FinanceiroCapitalGiro = () => {
  ...
  const consolidated: CapitalDeGiro | null = data.length > 0
    ? {
        company: 'consolidado',
        total_cr_aberto: data.reduce((s, d) => s + d.total_cr_aberto, 0),
        total_cp_aberto: data.reduce((s, d) => s + d.total_cp_aberto, 0),
        ...
        pmr: data.length > 0 ? Math.round(data.reduce((s, d) => s + d.pmr, 0) / data.length) : 0,
        pmp: data.length > 0 ? Math.round(data.reduce((s, d) => s + d.pmp, 0) / data.length) : 0,
        ciclo_financeiro: data.length > 0 ? Math.round(data.reduce((s, d) => s + d.ciclo_financeiro, 0) / data.length) : 0,
        top5_cr_pct: 0,
        top5_cp_pct: 0,
