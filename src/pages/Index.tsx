...
import { PlusCircle, ClipboardList, Headphones, ChevronRight, Wrench, Calendar, User, Sparkles, ArrowRight, TrendingUp, Package } from 'lucide-react';
...
const Index = () => {
  ...
  useEffect(() => {
    const loadData = async () => {
      ...
      try {
        const [profileResult, ordersResult, toolsResult] = await Promise.all([
          supabase
            .from('profiles')
