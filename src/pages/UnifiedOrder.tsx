...
const UnifiedOrder = () => {
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-4 pb-20">
      ...
      <OrderStepper step={h.currentStep} />
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
        ...
        <div className="space-y-4">
          ...
          {h.customerUserId && h.productItems.length > 0 && (
          ...
          {h.cart.length > 0 && h.selectedCustomer && (
            <CartSummaryBar
              ...
              vendedorDivergencias={h.vendedorDivergencias}
              sortedFormasPagamentoOben={h.sortedFormasPagamentoOben} sortedFormasPagamentoColacor={h.sortedFormasPagamentoColacor}
