...
// snapshot. 200/página = 4× menos páginas → 4× menos sleeps. PURA PERF: mesmas POs, zero mudança de semântica
// (a derivação/de-dup/etapa-filtro independem do tamanho da página). O físico já usa 500/página sem problema.
