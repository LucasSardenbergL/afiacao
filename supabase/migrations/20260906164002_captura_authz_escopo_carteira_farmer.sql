...
BEGIN
  FOR r IN
    SELECT * FROM (VALUES
      ('public.farmer_recomendacoes_substituir(uuid, uuid, uuid, jsonb, text, text, jsonb, uuid)',        'b19de14fcff1a5cc7c440c25712d2e04'),
      ('public.farmer_bundle_recomendacoes_substituir(uuid, uuid, uuid, jsonb, text, text, jsonb, uuid)', '38f8855de795ea4e6e8406aacdbdc3c3')
